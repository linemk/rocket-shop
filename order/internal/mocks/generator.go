...
//go:generate mockgen --package mocks --destination order_producer_service_mock.go github.com/linemk/rocket-shop/order/internal/service OrderProducerService
